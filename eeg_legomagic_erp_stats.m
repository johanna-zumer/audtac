    ...
    for tt=1:4 % refers to lim=[no-limit .01 .005 .002];
      ...
      for ss=tr.stageuse+10
        ...
        for ll=[soalist soalist+20 soalist+40]
          ...
          if size(tlock_tac{ll,tt,ss}.trial,1)
            cfg=[];
            cfg.lpfilter='yes';
            cfg.lpfreq=40;
            cfg.demean='yes';
          ...
          if size(tlock_aud{ll,tt,ss}.trial,1)
            cfg=[];
            cfg.lpfilter='yes';
            cfg.lpfreq=40;
            %         cfg.bpfilter='yes';
        ...
        for ll=[soalist+50 soalist+60]
          if size(tlock_nul{ll,tt,ss}.trial,1)
            cfg=[];
            cfg.lpfilter='yes';
            cfg.lpfreq=40;
            cfg.demean='yes';
...
%       load(['tlock_diffs_averef_' sub{ii} '.mat']);
      ...
      load(['trialkept_tt' num2str(ttin) '_sleep' num2str(sleep) '.mat'],'tr')
      ...
      if sum(numtrt(ll,tt,ssuse,ii-submin),3)<20 % what is best number to use here?
...
%     for ii=1:length(subuse)
    ...
    if allcond_sameN
      print(20,['D:\audtac\figs\sumuni_mspn_diff_ta_cond' num2str(ll) num2str(tt) 'a25.png'],'-dpng')
    else
    ...
    for ii=1:subuseindfinal
      ...
      subplot(3,subuseindfinal,ii);imagesc(tlock_audPtac{ii}.time,1:63,tlock_audPtac{ii}.avg);caxis([-6 6])
      subplot(3,subuseindfinal,subuseindfinal+ii);imagesc(tlock_audMSpN{ii}.time,1:63,tlock_audMSpN{ii}.avg);caxis([-6 6])
      subplot(3,subuseindfinal,2*subuseindfinal+ii);imagesc(diff{ii}.time,1:63,diff{ii}.avg);caxis([-6 6])
      %       plotind=plotind+1;
    end
    if allcond_sameN
      print(21,['D:\audtac\figs\sumuni_mspn_diff_at_cond' num2str(ll) num2str(tt) 'a25.png'],'-dpng')
    else
    ...
    if allcond_sameN
      print(11,['D:\audtac\figs\gravetacPaud_topoOverTime_cond' num2str(ll) num2str(tt)  '_25.png'],'-dpng')
    else
      print(11,['D:\audtac\figs\gravetacPaud_topoOverTime_cond' num2str(ll) num2str(tt)  '_28.png'],'-dpng')
    end
    if allcond_sameN
      print(12,['D:\audtac\figs\graveaudPtac_topoOverTime_cond' num2str(ll) num2str(tt)  '_25.png'],'-dpng')
    else
      print(12,['D:\audtac\figs\graveaudPtac_topoOverTime_cond' num2str(ll) num2str(tt)  '_28.png'],'-dpng')
    end
    if allcond_sameN
      print(13,['D:\audtac\figs\gravetacMSpN_topoOverTime_cond' num2str(ll) num2str(tt)  '_25.png'],'-dpng')
    else
      print(13,['D:\audtac\figs\gravetacMSpN_topoOverTime_cond' num2str(ll) num2str(tt)  '_28.png'],'-dpng')
    end
    if allcond_sameN
      print(14,['D:\audtac\figs\graveaudMSpN_topoOverTime_cond' num2str(ll) num2str(tt)  '_25.png'],'-dpng')
    else
    ...
    %     end
    if allcond_sameN
      print(22,['D:\audtac\figs\grdiff_topoOverTime_mc_ta_cond' num2str(ll) num2str(tt) 'a25.png'],'-dpng')
    else
    ...
    %     end
    if allcond_sameN
      print(23,['D:\audtac\figs\grdiff_topoOverTime_mc_at_cond' num2str(ll) num2str(tt) 'a25.png'],'-dpng')
    else
