...
F{10}=[1 1 1 0 0 0 0]';  % A 3
F{11}=[0 0 0 0 1 1 1]';  % A 3
F{12}=[0 1 1 1 0 0 0]';  % A 3
F{13}=[0 0 0 1 1 1 0]';  % A 3

F{14}=[1 1 1 1 0 0 0]';  % A 4
F{15}=[0 0 0 1 1 1 1]';  % A 4

% 'Component 4': Off-centre TIW
F{16}=[0 1 1 1 1 0 0]';  % A 4
F{17}=[0 0 1 1 1 1 0]';  % A 4

F{18}=[1 1 1 1 1 0 0]';  % A 5
F{19}=[0 0 1 1 1 1 1]';  % A 5

F{20}=[1 1 1 1 1 1 0]';  % A 6
F{21}=[0 1 1 1 1 1 1]';  % A 6
