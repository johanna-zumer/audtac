...
% Kc/SW:  If negmax between 400-750 ms, then is KcEvoked, where time window is after second stimulus
...
for kk=1:numtr
  ...
  for nk=1:numKc
    if ll % relative to postadd
      ...
      if data.kc{kk}(nk).negmax<0.75+postadd(ll) && data.kc{kk}(nk).negmax>0.4+postadd(ll)
        featind.KcEvoked(kk)=1;
      end
    else % relative to 0ms always
      if data.kc{kk}(nk).upend<0 && data.kc{kk}(nk).upend>-0.5
        featind.KcPre(kk)=1;
      end
      if data.kc{kk}(nk).down<0 && data.kc{kk}(nk).upend>0
        featind.KcDuring(kk)=1;
      end
      if data.kc{kk}(nk).negmax<0.75 && data.kc{kk}(nk).negmax>0.4
        featind.KcEvoked(kk)=1;
      end
    end
  ...
  for nk=1:numKc
    if ll % relative to postadd
      ...
      if data.sw{kk}(nk).negmax<0.75+postadd(ll) && data.sw{kk}(nk).negmax>0.4+postadd(ll)
        featind.KcEvoked(kk)=1;
      end
    else % relative to 0ms always
      if data.sw{kk}(nk).upend<0 && data.sw{kk}(nk).upend>-0.5
        featind.KcPre(kk)=1;
      end
      if data.sw{kk}(nk).down<0 && data.sw{kk}(nk).upend>0
        featind.KcDuring(kk)=1;
      end
      if data.sw{kk}(nk).negmax<0.75 && data.sw{kk}(nk).negmax>0.4
        featind.KcEvoked(kk)=1;
      end
    end
  ...
  for nk=1:numSp
    if ll % relative to postadd
      ...
      if data.sp_fast{kk}(nk).starttime<3+postadd(ll) && data.sp_fast{kk}(nk).starttime>0.1+postadd(ll)
        featind.SpEvoked(kk)=1;
      end
    else % relative to 0ms always
      if data.sp_fast{kk}(nk).endtime<0 && data.sp_fast{kk}(nk).endtime>-0.5
        featind.SpPre(kk)=1;
      end
      if data.sp_fast{kk}(nk).starttime<0 && data.sp_fast{kk}(nk).endtime>0
        featind.SpDuring(kk)=1;
      end
      if data.sp_fast{kk}(nk).starttime<3 && data.sp_fast{kk}(nk).starttime>0.1
        featind.SpEvoked(kk)=1;
      end
    end
  ...
  for nk=1:numSp
    if ll % relative to postadd
      ...
      if data.sp_slow{kk}(nk).starttime<3+postadd(ll) && data.sp_slow{kk}(nk).starttime>0.1+postadd(ll)
        featind.SpEvoked(kk)=1;
      end
    else % relative to 0ms always
      if data.sp_slow{kk}(nk).endtime<0 && data.sp_slow{kk}(nk).endtime>-0.5
        featind.SpPre(kk)=1;
      end
      if data.sp_slow{kk}(nk).starttime<0 && data.sp_slow{kk}(nk).endtime>0
        featind.SpDuring(kk)=1;
      end
      if data.sp_slow{kk}(nk).starttime<3 && data.sp_slow{kk}(nk).starttime>0.1
        featind.SpEvoked(kk)=1;
      end
    end
