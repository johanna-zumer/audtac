...
if sleep
  ...
  %     iiuse=setdiff(iiBuse,[3:7 8]);
    ...
    iteruse=11;
%     try  % this is circular....requires eeg_legomagic_erp_stats_only to be run first (computetrlkeep=1) to generate this file.
...
% for ii=8
  cd([edir sub{ii} ])
  clearvars -except ii sub edir ddir ii*use sleep featurestats* ttuse soades usetr tacaloneproc synchasynch phaset0* binonly pcmflag plothist iter* trialkc* subuseall trlkeep*
      ...
      if ll<40
        if isfield(tlock_tac{ll,tt,ss},'trial') && size(tlock_tac{ll,tt,ss}.trial,1)
          if phaset0 && phaset0use==0
            ...
            if sleep && ss==12 && ll<10  % multisensory trials
              keyboard
...
%               cfg.trials=trlkeepKD_tacMSpN{find(subuseall==ii),ll};
...
%               cfg.trials=trlkeepKP_tacMSpN{find(subuseall==ii),ll};
%               tlock_tactlock_nKP{ll,tt,ss}=ft_timelockanalysis(cfg,tlock_tac{ll,tt,ss});
%               tlock_tactlock_nKP{ll,tt,ss}=rmfield(tlock_tactlock_nKP{ll,tt,ss},{'var' 'dof'});
%               cfg.trials=trlkeepKE_tacMSpN{find(subuseall==ii),ll};
%               tlock_tactlock_nKE{ll,tt,ss}=ft_timelockanalysis(cfg,tlock_tac{ll,tt,ss});
%               tlock_tactlock_nKE{ll,tt,ss}=rmfield(tlock_tactlock_nKE{ll,tt,ss},{'var' 'dof'});
%               cfg.trials=trlkeepSD_tacMSpN{find(subuseall==ii),ll};
...
%               cfg.trials=trlkeepSP_tacMSpN{find(subuseall==ii),ll};
%               tlock_tactlock_nSP{ll,tt,ss}=ft_timelockanalysis(cfg,tlock_tac{ll,tt,ss});
%               tlock_tactlock_nSP{ll,tt,ss}=rmfield(tlock_tactlock_nSP{ll,tt,ss},{'var' 'dof'});
%               cfg.trials=trlkeepSE_tacMSpN{find(subuseall==ii),ll};
%               tlock_tactlock_nSE{ll,tt,ss}=ft_timelockanalysis(cfg,tlock_tac{ll,tt,ss});
%               tlock_tactlock_nSE{ll,tt,ss}=rmfield(tlock_tactlock_nSE{ll,tt,ss},{'var' 'dof'});
            end
            if sleep && ss==12 && ll>20 % tactile alone trials
              fn=setdiff(fieldnames(featstruct_tac{ll,tt,ss}),{'cfg' 'time' 'trialinfo' 'dimord' 'label'});
              for ff=1:length(fn)
                tlock_tac{ll,tt,ss}.(fn{ff})=featstruct_tac{ll,tt,ss}.(fn{ff});
              end
              featind_tac{ll} = feat_pre_during_evoked_individual(tlock_tac{ll,tt,ss},0); % 

              
%               cfg.trials=trlkeepKD_tacPaud{find(subuseall==ii),ll-20};
%               tlock_tactlock_nKD{ll,tt,ss}=ft_timelockanalysis(cfg,tlock_tac{ll,tt,ss});
%               tlock_tactlock_nKD{ll,tt,ss}=rmfield(tlock_tactlock_nKD{ll,tt,ss},{'var' 'dof'});
%               cfg.trials=trlkeepKP_tacPaud{find(subuseall==ii),ll-20};
%               tlock_tactlock_nKP{ll,tt,ss}=ft_timelockanalysis(cfg,tlock_tac{ll,tt,ss});
%               tlock_tactlock_nKP{ll,tt,ss}=rmfield(tlock_tactlock_nKP{ll,tt,ss},{'var' 'dof'});
%               cfg.trials=trlkeepKE_tacPaud{find(subuseall==ii),ll-20};
%               tlock_tactlock_nKE{ll,tt,ss}=ft_timelockanalysis(cfg,tlock_tac{ll,tt,ss});
%               tlock_tactlock_nKE{ll,tt,ss}=rmfield(tlock_tactlock_nKE{ll,tt,ss},{'var' 'dof'});
%               cfg.trials=trlkeepSD_tacPaud{find(subuseall==ii),ll-20};
%               tlock_tactlock_nSD{ll,tt,ss}=ft_timelockanalysis(cfg,tlock_tac{ll,tt,ss});
%               tlock_tactlock_nSD{ll,tt,ss}=rmfield(tlock_tactlock_nSD{ll,tt,ss},{'var' 'dof'});
%               cfg.trials=trlkeepSP_tacPaud{find(subuseall==ii),ll-20};
%               tlock_tactlock_nSP{ll,tt,ss}=ft_timelockanalysis(cfg,tlock_tac{ll,tt,ss});
%               tlock_tactlock_nSP{ll,tt,ss}=rmfield(tlock_tactlock_nSP{ll,tt,ss},{'var' 'dof'});
%               cfg.trials=trlkeepSE_tacPaud{find(subuseall==ii),ll-20};
%               tlock_tactlock_nSE{ll,tt,ss}=ft_timelockanalysis(cfg,tlock_tac{ll,tt,ss});
%               tlock_tactlock_nSE{ll,tt,ss}=rmfield(tlock_tactlock_nSE{ll,tt,ss},{'var' 'dof'});
            end
...
%               cfg.trials=trlkeepKD_tacPaud{find(subuseall==ii),ll-40};
...
%               cfg.trials=trlkeepKP_tacPaud{find(subuseall==ii),ll-40};
%               tlock_audtlock_nKP{ll,tt,ss}=ft_timelockanalysis(cfg,tlock_aud{ll,tt,ss});
%               tlock_audtlock_nKP{ll,tt,ss}=rmfield(tlock_audtlock_nKP{ll,tt,ss},{'var' 'dof'});
%               cfg.trials=trlkeepKE_tacPaud{find(subuseall==ii),ll-40};
%               tlock_audtlock_nKE{ll,tt,ss}=ft_timelockanalysis(cfg,tlock_aud{ll,tt,ss});
%               tlock_audtlock_nKE{ll,tt,ss}=rmfield(tlock_audtlock_nKE{ll,tt,ss},{'var' 'dof'});
%               cfg.trials=trlkeepSD_tacPaud{find(subuseall==ii),ll-40};
...
%               cfg.trials=trlkeepSP_tacPaud{find(subuseall==ii),ll-40};
%               tlock_audtlock_nSP{ll,tt,ss}=ft_timelockanalysis(cfg,tlock_aud{ll,tt,ss});
%               tlock_audtlock_nSP{ll,tt,ss}=rmfield(tlock_audtlock_nSP{ll,tt,ss},{'var' 'dof'});
%               cfg.trials=trlkeepSE_tacPaud{find(subuseall==ii),ll-40};
%               tlock_audtlock_nSE{ll,tt,ss}=ft_timelockanalysis(cfg,tlock_aud{ll,tt,ss});
%               tlock_audtlock_nSE{ll,tt,ss}=rmfield(tlock_audtlock_nSE{ll,tt,ss},{'var' 'dof'});
            end
            if pcmflag
              if rem(ll,10)==1 || rem(ll,10)==3 || rem(ll,10)==4 || rem(ll,10)==5
                starttime=0;     endtime=.5;
    ...
    for ll=[soalist+50 ]
      if length(tr.nllttrialkept{ll-50,tt,ss})>=2 && isfield(tlock_nul{ll,tt,ss},'trial') && size(tlock_nul{ll,tt,ss}.trial,1)
        if phaset0 && phaset0use==0
          ...
          if sleep && ss==12
            cfg.trials=trlkeepKD_tacMSpN{find(subuseall==ii),ll-50};
            ...
            cfg.trials=trlkeepKP_tacMSpN{find(subuseall==ii),ll-50};
            tlock_nultlock_nKP{ll,tt,ss}=ft_timelockanalysis(cfg,tlock_nul{ll,tt,ss});
            tlock_nultlock_nKP{ll,tt,ss}=rmfield(tlock_nultlock_nKP{ll,tt,ss},{'var' 'dof'});
            cfg.trials=trlkeepKE_tacMSpN{find(subuseall==ii),ll-50};
            tlock_nultlock_nKE{ll,tt,ss}=ft_timelockanalysis(cfg,tlock_nul{ll,tt,ss});
            tlock_nultlock_nKE{ll,tt,ss}=rmfield(tlock_nultlock_nKE{ll,tt,ss},{'var' 'dof'});
            cfg.trials=trlkeepSD_tacMSpN{find(subuseall==ii),ll-50};
            ...
            cfg.trials=trlkeepSP_tacMSpN{find(subuseall==ii),ll-50};
            tlock_nultlock_nSP{ll,tt,ss}=ft_timelockanalysis(cfg,tlock_nul{ll,tt,ss});
            tlock_nultlock_nSP{ll,tt,ss}=rmfield(tlock_nultlock_nSP{ll,tt,ss},{'var' 'dof'});
            cfg.trials=trlkeepSE_tacMSpN{find(subuseall==ii),ll-50};
            tlock_nultlock_nSE{ll,tt,ss}=ft_timelockanalysis(cfg,tlock_nul{ll,tt,ss});
            tlock_nultlock_nSE{ll,tt,ss}=rmfield(tlock_nultlock_nSE{ll,tt,ss},{'var' 'dof'});
          end
          if pcmflag
            if rem(ll,10)==1 || rem(ll,10)==3 || rem(ll,10)==4 || rem(ll,10)==5
              starttime=0;     endtime=.5;
    ...
    for ll=soalist
      ...
      if numt_trials(ll,tt,ss)>=2
        ...
        if sleep==1 && ss==12
          tlock_tacPaud_nKP{ll,tt,ss}=ft_math(cfg,tlock_tactlock_nKP{ll+20,tt,ss},tlock_audtlock_nKP{ll+40,tt,ss}); % keeping tac centred but jitter aud (to match tlock_tac{X,tt})          
          ...
          tlock_tacPaud_nKE{ll,tt,ss}=ft_math(cfg,tlock_tactlock_nKE{ll+20,tt,ss},tlock_audtlock_nKE{ll+40,tt,ss}); % keeping tac centred but jitter aud (to match tlock_tac{X,tt})          
          tlock_tacPaud_nSP{ll,tt,ss}=ft_math(cfg,tlock_tactlock_nSP{ll+20,tt,ss},tlock_audtlock_nSP{ll+40,tt,ss}); % keeping tac centred but jitter aud (to match tlock_tac{X,tt})          
          ...
          tlock_tacPaud_nSE{ll,tt,ss}=ft_math(cfg,tlock_tactlock_nSE{ll+20,tt,ss},tlock_audtlock_nSE{ll+40,tt,ss}); % keeping tac centred but jitter aud (to match tlock_tac{X,tt})          
        end
        if phaset0
          cfg.parameter='avg';
          for bb=1:4
      ...
      if numt_trials(ll,tt,ss)>=2
        ...
        if sleep==1 && ss==12
          tlock_tacMSpN_nKP{ll,tt,ss}=ft_math(cfg,tlock_tactlock_nKP{ll,tt,ss},tlock_nultlock_nKP{ll+50,tt,ss}); % TA+N
          tlock_tacMSpN_nKD{ll,tt,ss}=ft_math(cfg,tlock_tactlock_nKD{ll,tt,ss},tlock_nultlock_nKD{ll+50,tt,ss}); % TA+N
          tlock_tacMSpN_nKE{ll,tt,ss}=ft_math(cfg,tlock_tactlock_nKE{ll,tt,ss},tlock_nultlock_nKE{ll+50,tt,ss}); % TA+N
          tlock_tacMSpN_nSP{ll,tt,ss}=ft_math(cfg,tlock_tactlock_nSP{ll,tt,ss},tlock_nultlock_nSP{ll+50,tt,ss}); % TA+N
          tlock_tacMSpN_nSD{ll,tt,ss}=ft_math(cfg,tlock_tactlock_nSD{ll,tt,ss},tlock_nultlock_nSD{ll+50,tt,ss}); % TA+N
          tlock_tacMSpN_nSE{ll,tt,ss}=ft_math(cfg,tlock_tactlock_nSE{ll,tt,ss},tlock_nultlock_nSE{ll+50,tt,ss}); % TA+N
        end
        if phaset0
          cfg.parameter='avg';
          for bb=1:4
