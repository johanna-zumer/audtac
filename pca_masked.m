function [aa1,aaa1,vvv1,bb1]=pca_masked(mask_use,fulldata_reshape,labels,pcuse,timepts,xlimlim,fdir,name,flipPC)
...
% Project condition weighting back to all data
