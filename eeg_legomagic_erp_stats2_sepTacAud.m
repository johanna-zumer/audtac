        ...
        for ss=ssuse
          ...
          if phaset0 && phaset0use && [(sleep==0 && ss==10) || (sleep==1 && ss==12)]
            switch phaset0use
              case {1 2 3}
                if trialkc==0
                  ...
                  load(['freqtime0_averef_' sub{ii} '_sleep' num2str(sleep) '_tacaud' num2str(1) '_tt' num2str(tt) '_trialkc' num2str(trialkc) '.mat']);
                end
              case {4 5 6}
            ...
            for ll=soalist
              ...
              tacbin{ll,tt,ss}=bin_my_angle(tacang{ll,tt,ss},4);
              audbin{ll,tt,ss}=bin_my_angle(audang{ll,tt,ss},4);
              nulbin{ll,tt,ss}=bin_my_angle(nulang{ll,tt,ss},4);
              ms1bin{ll,tt,ss}=bin_my_angle(ms1ang{ll,tt,ss},4);
              ms2bin{ll,tt,ss}=bin_my_angle(ms2ang{ll,tt,ss},4);
              tac4mscon1bin{ll,tt,ss}=bin_my_angle(tac4mscon1ang{ll,tt,ss},4);
              tac4mscon2bin{ll,tt,ss}=bin_my_angle(tac4mscon2ang{ll,tt,ss},4);
              aud4mscon1bin{ll,tt,ss}=bin_my_angle(aud4mscon1ang{ll,tt,ss},4);
              aud4mscon2bin{ll,tt,ss}=bin_my_angle(aud4mscon2ang{ll,tt,ss},4);
              nul4mscon1bin{ll,tt,ss}=bin_my_angle(nul4mscon1ang{ll,tt,ss},4);
              nul4mscon2bin{ll,tt,ss}=bin_my_angle(nul4mscon2ang{ll,tt,ss},4);
              ms4mscon1bin{ll,tt,ss}=bin_my_angle(ms4mscon1ang{ll,tt,ss},4);
              ms4mscon2bin{ll,tt,ss}=bin_my_angle(ms4mscon2ang{ll,tt,ss},4);
              ...
              %               tacPaud1bin{ll,tt,ss}=bin_my_angle(tacPaud1ang{ll,tt,ss},4);
              %               tacPaud2bin{ll,tt,ss}=bin_my_angle(tacPaud2ang{ll,tt,ss},4);
              %               tacMSpN1bin{ll,tt,ss}=bin_my_angle(tacMSpN1ang{ll,tt,ss},4);
              %               tacMSpN2bin{ll,tt,ss}=bin_my_angle(tacMSpN2ang{ll,tt,ss},4);
              %               tacAmN1bin{ll,tt,ss}=bin_my_angle(tacAmN1ang{ll,tt,ss},4);
              %               tacAmN2bin{ll,tt,ss}=bin_my_angle(tacAmN2ang{ll,tt,ss},4);
              %               tacTmN1bin{ll,tt,ss}=bin_my_angle(tacTmN1ang{ll,tt,ss},4);
              %               tacTmN2bin{ll,tt,ss}=bin_my_angle(tacTmN2ang{ll,tt,ss},4);
              %               tacMSmA1bin{ll,tt,ss}=bin_my_angle(tacMSmA1ang{ll,tt,ss},4);
              %               tacMSmA2bin{ll,tt,ss}=bin_my_angle(tacMSmA2ang{ll,tt,ss},4);
              %               tacMSmT1bin{ll,tt,ss}=bin_my_angle(tacMSmT1ang{ll,tt,ss},4);
              ...
              tacabsbin{ll,tt,ss}=bin_my_abs(tacabs{ll,tt,ss},xbin);
              audabsbin{ll,tt,ss}=bin_my_abs(audabs{ll,tt,ss},xbin);
              nulabsbin{ll,tt,ss}=bin_my_abs(nulabs{ll,tt,ss},xbin);
              ms1absbin{ll,tt,ss}=bin_my_abs(ms1abs{ll,tt,ss},xbin);
              ms2absbin{ll,tt,ss}=bin_my_abs(ms2abs{ll,tt,ss},xbin);
              ...
              tac4mscon1absbin{ll,tt,ss}=bin_my_abs(tac4mscon1abs{ll,tt,ss},xbin);
              aud4mscon1absbin{ll,tt,ss}=bin_my_abs(aud4mscon1abs{ll,tt,ss},xbin);
              ...
              tac4mscon2absbin{ll,tt,ss}=bin_my_abs(tac4mscon2abs{ll,tt,ss},xbin);
              aud4mscon2absbin{ll,tt,ss}=bin_my_abs(aud4mscon2abs{ll,tt,ss},xbin);
              nul4mscon2absbin{ll,tt,ss}=bin_my_abs(nul4mscon2abs{ll,tt,ss},xbin);
              ms4mscon2absbin{ll,tt,ss}=bin_my_abs(ms4mscon2abs{ll,tt,ss},xbin);
...
nsub=size(tlock_tac9T_gndavgtopWP2N1{ss,tk}.individual,1);
% try for just one channel of main effect.
cfg=[];
  ...
  for iter=iteruse
    for tt=[3]
      ...
      for ll=[5]
        ...
        if tacnulmsaudstatsflag
          ...
          if sleep
            save([edir 'tlock_statmsaud_sleep' num2str(sleep) '_ss' num2str(ss) '_iter' num2str(iter) '_trialkc' num2str(trialkc) '.mat'],'statt_msaudmc');
          else
            save([edir 'tlock_statmsaud_sleep' num2str(sleep) '_iter' num2str(iter) '.mat'],'statt_msaudmc');
          end
          %
        ...
        if statsflag
          ...
          save([edir 'tlock_statmc_early_sleep' num2str(sleep) '_ss' num2str(ss) '_iter' num2str(iter) '_trialkc' num2str(trialkc) '.mat'],'stat*early');
          %             continue
          %           end
          ...
          if iterflag
            if sleep
              %               if trialkcflag
              save([edir 'tlock_statmc_sleep' num2str(sleep) '_ss' num2str(ss) '_iter' num2str(iter) '_trialkc' num2str(trialkc) '.mat'],'stat*');
              %               else
              %                 save([edir 'tlock_statmc_sleep' num2str(sleep) '_ss' num2str(ss) '_iter' num2str(iter) '.mat'],'stat*');
              %               end
            else
              save([edir 'tlock_statmc_sleep' num2str(sleep) '_iter' num2str(iter) '.mat'],'stat*');
            end
          else
            if runagain==1
    ...
    if savegrindflag
      if ~iterflag
        ...
        if sleep
          save([edir 'tlock_grind_sleep' num2str(sleep) '_ss' num2str(ss) '_iter' num2str(iter) '_trialkc' num2str(trialkc) '.mat'],'grave*T*','grind_*save','plv');
        else
          save([edir 'tlock_grind_sleep' num2str(sleep) '_iter' num2str(iter) '.mat'],'grave*T*','grind_*save','plv');
        end
      end
    end
  end % iter
...
close all;
for ll=soalist
  if ll<5 % funny 'temporal' (in)congruency contrast
    cfg=[];
    cfg.operation='subtract';
    cfg.parameter='individual';
...
for ii=iiuse
  ...
  for bb=1:4
    ...
    tlockavg_tac5con1_phasebin{bb}{subuseind}=tlock_tac4mscon1_phasebin{5,3,10,bb};
    tlockavg_aud5con1_phasebin{bb}{subuseind}=tlock_aud4mscon1_phasebin{5,3,10,bb};
    tlockavg_nul5con1_phasebin{bb}{subuseind}=tlock_nul4mscon1_phasebin{5,3,10,bb};
    
    for ll=soalist
      tlockavg_msllcon1_phasebin{ll,bb}{subuseind}=tlock_ms4mscon1_phasebin{ll,3,10,bb};
      tlockavg_nulllcon1_phasebin{ll,bb}{subuseind}=tlock_nul4mscon1_phasebin{ll,3,10,bb};
      tlockavg_msllcon2_phasebin{ll,bb}{subuseind}=tlock_ms4mscon2_phasebin{ll,3,10,bb};
      tlockavg_nulllcon2_phasebin{ll,bb}{subuseind}=tlock_nul4mscon2_phasebin{ll,3,10,bb};
    end % ll
...
if statsflag
  ...
  save([edir 'stat_pb_uninul.mat'],'stat*')
end % statsflag
