...
montage.labelnew={'EOG oH F7-F8' 'EMG o FT9-FT10' 'EOG oV Fp2-FT9' 'EOG oV Fp1-FT10' 'Fz-LM' 'Cz-LM' 'Oz-LM'    'Cz-C3' 'C4-Cz' 'Cz-Pz' 'Cz-Fz'  'Fz-F3' 'F4-Fz'  'EOG V' 'EOG H' 'EMGchin' 'E CG-LM'}
...
montage.tra(14,match_str(montage.labelorg,'VEOG'))=1;
montage.tra(15,match_str(montage.labelorg,'HEOG'))=1;
montage.tra(16,match_str(montage.labelorg,'EMG'))=1;
montage.tra(17,match_str(montage.labelorg,'ECG'))=1;
montage.tra(17,match_str(montage.labelorg,'TP9'))=-.5;
montage.tra(17,match_str(montage.labelorg,'TP10'))=-.5;
...
save('D:\audtac\eeg_data\sleepMontage_combo_ExG.mat','montage')
