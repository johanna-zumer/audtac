function tfr_subchannel_3cond_plotRows_pow(pow,chansel,zlim,figinds,figstrings,baseline)
% function tfr_subchannel_3cond_plotRows_pow(tmp,tmpu,tmpm,chansel,zlim,figinds,figstrings,baseline)
