...
%% With 17-20 instead of 11-14, AND ones (F{21})

% Model 23: Asymmetry; and eye
M{end+1}.type       = 'feature';
M{end}.numGparams = 12;
M{end}.Ac = zeros(ncond,12,M{end}.numGparams);
for ff=1:7
...
M{end}.Ac(:,10,10)  = F{19};
M{end}.Ac(:,11,11)  = F{20};
M{end}.Ac(:,end,end)  = F{21};
M{end}.name       = 'AI'; 

% Model 24: TIW a and b;  Asymmetry; and eye
M{end+1}.type       = 'feature';
M{end}.numGparams = 14;
M{end}.Ac = zeros(ncond,14,M{end}.numGparams);
for ff=1:7
...
% Model 25: Asymmetry;  Symmetric Pairs; and eye
M{end+1}.type       = 'feature';
M{end}.numGparams = 15;
...
% Model 27: Eye: All conditions independent variance
M{end+1}.type       = 'feature';
M{end}.numGparams = 8;
for ff=1:7
  M{end}.Ac(:,1:ncond,ff)  = F{ff};
...
% Model 30: Symmetric Pairs; and eye
M{end+1}.type       = 'feature';
M{end}.numGparams = 11;
M{end}.Ac = zeros(ncond,11,M{end}.numGparams);
for ff=1:7
...
% Model 31: TIW a and b;  Asymmetry; and eye
M{end+1}.type       = 'feature';
M{end}.numGparams = 14;
M{end}.Ac = zeros(ncond,14,M{end}.numGparams);
for ff=1:7
...
% Model 32: TIW a and b;  Symmetric Pairs; and eye
M{end+1}.type       = 'feature';
M{end}.numGparams = 13;
M{end}.Ac = zeros(ncond,13,M{end}.numGparams);
for ff=1:7
...
% Model 33: Asymmetry;  Symmetric Pairs; and eye
M{end+1}.type       = 'feature';
M{end}.numGparams = 15;
M{end}.Ac = zeros(ncond,15,M{end}.numGparams);
for ff=1:7
...
% Model 34: TIW a and b;  Asymmetry;  Symmetric Pairs; and eye
M{end+1}.type       = 'feature';
M{end}.numGparams = 17;
M{end}.Ac = zeros(ncond,17,M{end}.numGparams);
for ff=1:7
...
save([edir 'sim4eNR_featmodels.mat'],'M');
