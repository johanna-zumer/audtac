...
G_1a=nearestSPD(rdm2G(jz_udnorm(rdmodel_1a),plotflag,'model 1a'));

rdmodel_1b=1-eye(7);
rdmodel_1b(2:6,2:6)=0;
G_1b=nearestSPD(rdm2G(jz_udnorm(rdmodel_1b),plotflag,'model 1b'));


rdmodel_1c=1-eye(7);
rdmodel_1c(2:5,2:5)=0;
G_1c=nearestSPD(rdm2G(jz_udnorm(rdmodel_1c),plotflag,'model 1c'));

rdmodel_1d=1-eye(7);
rdmodel_1d(3:6,3:6)=0;
G_1d=nearestSPD(rdm2G(jz_udnorm(rdmodel_1d),plotflag,'model 1d'));

rdmodel_1e=1-eye(7);
rdmodel_1e(2:4,2:4)=0;
G_1e=nearestSPD(rdm2G(jz_udnorm(rdmodel_1e),plotflag,'model 1e'));

rdmodel_1f=1-eye(7);
rdmodel_1f(4:6,4:6)=0;
G_1f=nearestSPD(rdm2G(jz_udnorm(rdmodel_1f),plotflag,'model 1f'));

% 2) Asymmetry: AT will be similar to each other but different from TA (vice versa)
rdmodel_2a=1-eye(7);
rdmodel_2a(1:4,1:4)=0;
rdmodel_2a(4:7,4:7)=0;
rdmodel_2a_norm = jz_udnorm(rdmodel_2a);
...
rdmodel_3a(6,2)=0;
rdmodel_3a(7,1)=0;
G_3a=nearestSPD(rdm2G(jz_udnorm(rdmodel_3a),plotflag,'model 3'));
...
G_1a2a=nearestSPD(rdm2G(jz_udnorm(interact_1a2a),plotflag,'model 1a X 2'));
G_1b2a=nearestSPD(rdm2G(jz_udnorm(interact_1b2a),plotflag,'model 1b X 2'));
G_1a3a=nearestSPD(rdm2G(jz_udnorm(interact_1a3a),plotflag,'model 1a X 3'));
G_1b3a=nearestSPD(rdm2G(jz_udnorm(interact_1b3a),plotflag,'model 1b X 3'));
G_2a3a=nearestSPD(rdm2G(jz_udnorm(interact_2a3a),plotflag,'model 2 X 3'));
