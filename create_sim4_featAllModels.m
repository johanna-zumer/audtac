...
M{end}.Ac(:,1:ncond,1)  = F{1};
M{end}.Ac(:,1:ncond,2)  = F{2};
M{end}.Ac(:,1:ncond,3)  = F{3};
M{end}.Ac(:,1:ncond,4)  = F{4};
M{end}.Ac(:,8,5)  = F{15};
M{end}.Ac(:,9,6)  = F{16};
...
M{end}.Ac(:,13,10)  = F{13};
M{end}.Ac(:,14,11)  = F{14};
M{end}.Ac(:,15,12)  = F{15};  % TIW
M{end}.Ac(:,16,13)  = F{16};  % TIW
M{end}.Ac(:,17,14)  = F{5};
...
save([edir 'sim4_featmodels.mat'],'M');
